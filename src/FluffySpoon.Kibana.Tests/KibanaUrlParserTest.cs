...
namespace FluffySpoon.Kibana.Tests
{
  ...
  ""lon"": 13.194580078125002
        ...
        {
            var result = new KibanaParser().ConvertUrlToElasticsearchQueryString("http://localhost:5601/app/kibana#/discover/dbacd250-2d63-11ea-b9ee-9ba1601481ef?_g=(filters:!(),refreshInterval:(pause:!t,value:0),time:(from:now-8y,to:now))&_a=(columns:!(_source),filters:!(('$state':(store:appState),meta:(alias:!n,disabled:!f,index:aec561e0-1511-11ea-a5d4-651ed6b2498e,key:email,negate:!f,params:(query:'foobar@example.com'),type:phrase),query:(match:(email:(query:'foobar@example.com',type:phrase))))),index:aec561e0-1511-11ea-a5d4-651ed6b2498e,interval:auto,query:(language:kuery,query:''),sort:!(!(createdUtc,desc)))", "stuff");
            JsonConvert.DeserializeObject(result);
        }
        ...
        [TestMethod]
        public void CanParseComplexObject8()
        {
